...
execute if score CTLeft1Kills GameProcess >= #TNum sort if score CTWinTheRound GameProcess matches 1 run tellraw @a [{"text":"[MVP]","color":"yellow","bold":true},{"text":"王牌！","color":"yellow","bold":false},{"selector":"@s","bold":false},{"text":"孤军奋战，击杀了敌方","color":"white","bold":false},{"text":"所有","color":"yellow","bold":true},{"text":"在队友全阵亡后，","color":"white","bold": false},{"text":"玩家并赢得本局胜利！","color":"white","bold":false}]
