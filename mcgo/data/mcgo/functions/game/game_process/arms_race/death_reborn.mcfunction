...
execute if score pool SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=T,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers 36 -21 1 2 under -59 false @s
...
execute if score ice SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=T,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers -1 4091 1 2 under -10 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
#圣马丁镇 stmarc
execute if score stmarc SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=T,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers -106 3638 1 2 under -20 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
#湖畔激战 lake
execute if score lake SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=T,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers 59 -2113 1 2 under -5 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
...
execute if score pool SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=CT,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers 10 -21 1 2 under -59 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
#冰雪世界 ice
execute if score ice SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=CT,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers 10 4037 1 2 under -10 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
#圣马丁镇 stmarc
execute if score stmarc SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=CT,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers -94 3563 1 2 under -20 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
#湖畔激战 lake
execute if score lake SelectedMap matches 1 run scoreboard players set Allowonce GameProcess 1
    ...
    execute if score Allowonce GameProcess matches 1 as @a[team=CT,scores={Deaths=1..}] if score @s ArmsRaceSeed >= 5 ArmsRaceSeed run spreadplayers 62 -2030 1 2 under -3 false @s
    execute if score Allowonce GameProcess matches 1 run scoreboard players set Allowonce GameProcess 0
