...
execute as @s[scores={Points=4750..}] run item replace entity @s hotbar.0 with tacz:modern_kinetic_gun{GunId:"mcs2:cs_awp", HasBulletInBarrel:1b, GunFireMode:"SEMI", GunCurrentAmmoCount:5} 1
