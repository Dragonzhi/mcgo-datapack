execute if score @s Points matches ..1000 run tellraw @s [{"text":"你的没有足够的金钱购买下界合金套装！","color":"red"}]
...
execute if entity @s[scores={Allowance=1}] run item replace entity @s armor.head with netherite_helmet{GunUsed:0}
execute if entity @s[scores={Allowance=1}] run item replace entity @s armor.chest with netherite_chestplate{GunUsed:0}
