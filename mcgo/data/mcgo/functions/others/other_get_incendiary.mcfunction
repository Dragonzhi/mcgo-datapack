...
execute if score @s Allowance matches 1 run execute if score @s GetGunForFree matches 0 run execute unless score @s Points matches 600.. run scoreboard players set @s Allowance 2
    execute if score @s Allowance matches 2 run tellraw @s [{"text":"你没有足够的钱购买 燃烧弹","color":"red"}]
    execute if score @s Allowance matches 2 run scoreboard players set @s Allowance 0

execute if score @s Allowance matches 1 run execute if score @s GetGunForFree matches 0 run execute if score @s Points matches 600.. run scoreboard players set @s Allowance 10
    execute if score @s Allowance matches 10 run tellraw @s [{"text":"你已购买 ","color":"white"},{"text":"燃烧弹 ","color":"yellow"},{"text":"-600$","color":"red"}]
    execute if score @s Allowance matches 10 run scoreboard players remove @s Points 600
...
execute if score @s Allowance matches 10..11 run execute unless entity @s[nbt={Inventory:[{tag:{GunType:6},Slot:3b}]}] run scoreboard players set @s Allowance 1
    execute if score @s Allowance matches 1 run item replace entity @s hotbar.3 with csgrenades:incendiary{GunType:6,GunName:"燃烧弹",GunPrice:600,GunUsed:0}
...
execute if score @s Allowance matches 10..11 run execute run execute unless entity @s[nbt={Inventory:[{tag:{GunType:6},Slot:4b}]}] run scoreboard players set @s Allowance 1
    execute if score @s Allowance matches 1 run item replace entity @s hotbar.4 with csgrenades:incendiary{GunType:6,GunName:"燃烧弹",GunPrice:600,GunUsed:0}
    execute if score @s Allowance matches 1 run scoreboard players add @s BoughtIncendiary 1
    execute if score @s Allowance matches 1 run scoreboard players set @s Allowance 0
execute if score @s Allowance matches 10..11 run execute run execute unless entity @s[nbt={Inventory:[{tag:{GunType:6},Slot:5b}]}] run scoreboard players set @s Allowance 1
    execute if score @s Allowance matches 1 run item replace entity @s hotbar.5 with csgrenades:incendiary{GunType:6,GunName:"燃烧弹",GunPrice:600,GunUsed:0}
    execute if score @s Allowance matches 1 run scoreboard players add @s BoughtIncendiary 1
    execute if score @s Allowance matches 1 run scoreboard players set @s Allowance 0
execute if score @s Allowance matches 10..11 run execute run execute unless entity @s[nbt={Inventory:[{tag:{GunType:6},Slot:6b}]}] run scoreboard players set @s Allowance 1
    execute if score @s Allowance matches 1 run item replace entity @s hotbar.6 with csgrenades:incendiary{GunType:6,GunName:"燃烧弹",GunPrice:600,GunUsed:0}
    execute if score @s Allowance matches 1 run scoreboard players add @s BoughtIncendiary 1
    execute if score @s Allowance matches 1 run scoreboard players set @s Allowance 0
