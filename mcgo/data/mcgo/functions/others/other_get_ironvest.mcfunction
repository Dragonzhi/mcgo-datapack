...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:iron_helmet",Slot:103b,tag:{Damage:0}},{id:"minecraft:iron_chestplate",Slot:102b,tag:{Damage:0}}]}] run execute unless entity @s[nbt={Inventory:[{id:"air",Slot:103b},{id:"air",Slot:102b}]}] run execute unless entity @s[nbt={Inventory:[{id:"minecraft:netherite_helmet",Slot:103b},{id:"minecraft:netherite_chestplate",Slot:102b}]}] run execute if entity @s[scores={Points=650..}] run scoreboard players set @s Allowance 1
execute if entity @s[scores={Allowance=1}] run tellraw @s [{"text":"你已拥有铁套装，已补满耐久 ","color":"white"},{"text":"-$650","color":"red"}]
execute if entity @s[scores={Allowance=1}] run item replace entity @s armor.head with iron_helmet
execute if entity @s[scores={Allowance=1}] run item replace entity @s armor.chest with iron_chestplate
