...
execute if entity @s[nbt={Inventory:[{id:"minecraft:iron_helmet",Slot:103b,tag:{Damage:0}},{id:"minecraft:iron_chestplate",Slot:102b,tag:{Damage:0}}]}] run scoreboard players set @s Allowance 1
