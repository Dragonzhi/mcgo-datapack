...
execute if entity @s[nbt={Inventory:[{id:"minecraft:netherite_helmet",Slot:103b,tag:{Damage:0}},{id:"minecraft:netherite_chestplate",Slot:102b,tag:{Damage:0}}]}] run scoreboard players set @s Allowance 1
