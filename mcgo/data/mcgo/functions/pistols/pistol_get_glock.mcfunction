...
execute if entity @s[scores={Allowance=10}] run execute if score @s GetGunForFree matches 0 run execute if score @s GetGunForFree matches 0 run function mcgo:execute/pistol_isinitial
