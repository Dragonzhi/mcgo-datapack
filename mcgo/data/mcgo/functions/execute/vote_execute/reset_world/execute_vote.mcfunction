...
execute if score ResetWorld Vote matches -1 run playsound minecraft:ui.toast.out block @a ~ ~ ~ 15 1 1
...
execute if score ResetWorld Vote < #playersNumSet Vote run execute unless score ResetWorld Vote matches -1 run playsound minecraft:ui.toast.out block @a ~ ~ ~ 15 1 1
