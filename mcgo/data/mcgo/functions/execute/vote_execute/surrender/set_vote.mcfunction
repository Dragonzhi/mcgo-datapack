...
execute if score TSurrenderValid GameProcess matches 1 if score Voting Vote matches 0 run scoreboard players set Allowance GameProcess 1
    ...
    execute if score Allowance GameProcess matches 1 run execute if score CTSurrenderValid GameProcess matches 1 run scoreboard players set Allowance GameProcess 1
    ...
    execute if score Allowance GameProcess matches 1 run execute if score TSurrenderValid GameProcess matches 1 run scoreboard players set Allowance GameProcess 1
