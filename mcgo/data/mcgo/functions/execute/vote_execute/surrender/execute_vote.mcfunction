...
execute if score CTSurrender Vote matches -1 if score CTSurrenderValid GameProcess matches 1 run playsound minecraft:ui.toast.out block @a[team=CT] ~ ~ ~ 15 1 1
...
execute if score TSurrender Vote matches -1 if score TSurrenderValid GameProcess matches 1 run playsound minecraft:ui.toast.out block @a[team=T] ~ ~ ~ 15 1 1
...
execute if score CTSurrender Vote < #playersNumSet Vote if score CTSurrenderValid GameProcess matches 1 unless score CTSurrender Vote matches -1 run playsound minecraft:ui.toast.out block @a[team=CT] ~ ~ ~ 15 1 1
...
execute if score TSurrender Vote < #playersNumSet Vote if score TSurrenderValid GameProcess matches 1 unless score TSurrender Vote matches -1 run playsound minecraft:ui.toast.out block @a[team=T] ~ ~ ~ 15 1 1
