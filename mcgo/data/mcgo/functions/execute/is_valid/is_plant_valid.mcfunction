execute as @a[team=T,nbt={Inventory:[{id:"block_bettle:c_4_down"}]}] at @s if block ~ ~-30 ~ minecraft:diamond_block run execute as @a at @s run scoreboard players set Allowance GameProcess 1
...
execute as @a[team=T,nbt={Inventory:[{id:"block_bettle:c_4_down"}]}] at @s unless block ~ ~-30 ~ minecraft:diamond_block run execute as @a at @s run scoreboard players set Allowance GameProcess 1
