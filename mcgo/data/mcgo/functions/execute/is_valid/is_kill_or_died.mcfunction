...
execute if score S InGame matches 1 run execute as @a[team=T,scores={Deaths=1}] run scoreboard players reset @s Deaths
...
execute if score S InGame matches 1 run execute as @a[team=CT,scores={Deaths=1}] run scoreboard players reset @s Deaths
##击杀得分
