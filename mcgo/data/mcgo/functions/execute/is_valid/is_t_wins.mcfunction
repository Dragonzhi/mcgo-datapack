...
execute if entity @a[team=CT] run execute unless entity @a[team=CT,scores={Deaths=0}] run execute if score CTAllDied GameProcess matches 0 run scoreboard players set Allowance GameProcess 1
...
execute if entity @a[team=CT] run execute if score CTAllDied GameProcess matches 1 run execute if score RoundFinished GameProcess matches 0 run scoreboard players set TWinTheRound GameProcess 1
    ...
    execute if score TWinTheRound GameProcess matches 1 if score RoundFinished GameProcess matches 0 run function mcgo:game/game_process/normalmode/mvp_broadcast/mvp_broadcast
