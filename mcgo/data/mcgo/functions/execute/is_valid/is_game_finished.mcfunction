...
execute if score CTWinTheGame GameProcess matches 1 run execute if score GameFinished GameProcess matches 0 run scoreboard players set Allowance GameProcess 1
    ...
    execute if score Allowance GameProcess matches 1 run scoreboard players set S InGame 0
    ...
    execute if score Allowance GameProcess matches 1 run schedule function mcgo:game/reset_world 10s append
