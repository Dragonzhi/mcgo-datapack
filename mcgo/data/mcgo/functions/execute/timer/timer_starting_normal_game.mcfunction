...
execute unless score seconds GameProcess matches 0 run scoreboard players set StopStartingGame GameProcess 1
...
function mcgo:execute/timer/timer_starting_normal_game