...
execute if score minutes1 GameProcess matches 0 if score minutes2 GameProcess matches 0..1 run bossbar set mcs:deathmatch_game_process name [{"text":"死亡竞赛倒计时 ","color":"white","bold":false},{"score":{"name": "minutes2","objective": "GameProcess"},"color":"red","bold":true},{"text":" : ","color":"white","bold":false},{"score":{"name": "minutes1","objective": "GameProcess"},"color":"red","bold":true}]
